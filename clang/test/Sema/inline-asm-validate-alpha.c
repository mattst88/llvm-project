...
// 'G' and 'H' for floating-point constants and 'T' for a high-part
// relocation; accepting those would only move the failure to a back end with
// no case for them.
...
void unsupported(double d, int i) {
