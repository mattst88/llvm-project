...
enum {
  ...
  UNW_ALPHA_F30 = 62,
  UNW_ALPHA_F31 = 63,
  // Alpha has no architectural PC register.  DWARF number 64 is the
  // alternate return address column, which unwind information for signal
  // frames uses to describe the interrupted PC.
  UNW_ALPHA_PC = 64,
};
